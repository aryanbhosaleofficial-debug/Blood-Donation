...
const REQUEST_ERROR = Object.freeze({
  ...
  NOT_COVERED: 'REQUEST_NOT_COVERED',
});

// Which current states permit each hospital lifecycle action (Module 03 only).
const CANCELABLE_FROM = Object.freeze([REQUEST_STATUS.OPEN, REQUEST_STATUS.COVERED]);
const COMPLETABLE_FROM = Object.freeze([REQUEST_STATUS.COVERED]);
